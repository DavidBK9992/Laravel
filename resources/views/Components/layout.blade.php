...
<body class="h-full">
    <div class="min-h-full">
        <nav class="bg-gray-800">
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <a href="/contact" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white" type="button">Contact</a>
                </div>
        ...
        <header class="relative bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8   flex  sm:justify-between ">
